    ...
    <>
      ...
      <main className={styles.main}>
          <div className={styles.intro}>
              ...
              <h1 className={styles.introMobile}>multi-passionate <br/> Front-end Developer & <br/> UX/UI Designer</h1>

              <div className={styles.introRow1}>
                  <h1>multi-passionate</h1>
                  <Image className={styles.introParaImg} src={'/anne-zwickermann-1.jpg'} alt={'Anne'} height={260} width={260} />
              </div>
              <div className={styles.introRow2}>
                  <Image className={styles.introParaImg} src={'/anne-zwickermann-2.jpg'} alt={'Anne'} height={360} width={360} />
                  <h1>front-end dev &amp;</h1>
              </div>
              <div className={styles.introRow3}>
                <h1>designer</h1>
                <Image className={styles.introParaImg} src={'/anne-zwickermann-3.jpg'} alt={'Anne'} height={420} width={420} />
              </div>
